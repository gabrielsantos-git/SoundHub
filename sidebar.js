...
(function() {
    ...
    const sidebarHTML = `
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav style="flex:1;overflow-y:auto;">
                ...
                <a href="/accounts" class="sidebar-item" id="accountsDirectLink" style="display:none">
    ...
    window.updateSidebar = function(user) {
        ...
        const accountsDirectLink = document.getElementById('accountsDirectLink');
